...
def launch_setup(context, *args, **kwargs):
    ...
    planning_pipeline_file=os.path.join(pkg_share,'config','planning_pipeline_config.yaml')  # ✅ REQUIRED
    ...
    planning_pipeline_config = load_yaml(planning_pipeline_file)
    ...
    planning_pipelines_config = {
        ...
        'ompl': planning_pipeline_config.get('ompl', {}),
